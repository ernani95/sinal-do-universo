        ...
        <div className="min-h-screen bg-mystic-dark text-white pt-24 pb-12 px-6">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-mystic-purple/20 border border-white/10 p-8 rounded-3xl backdrop-blur-sm">
                    ...
                    <h1 className="text-3xl md:text-4xl font-display text-center mb-8 uppercase tracking-[0.2em]">Política de Privacidade</h1>
                    ...
                    <div className="space-y-6 text-mystic-muted leading-relaxed font-body text-sm md:text-base">
                        ...
                        <section>
                            <h2 className="text-xl font-display text-white mb-3">1. Dados Coletados</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-display text-white mb-3">2. Como Usamos Seus Dados</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-display text-white mb-3">3. Compartilhamento de Dados</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-display text-white mb-3 text-mystic-gold">4. Direitos do Usuário (LGPD)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-display text-white mb-3">5. Segurança</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-display text-white mb-3">7. Contato</h2>
                            <p>
