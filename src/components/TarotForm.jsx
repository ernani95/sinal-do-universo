...
import { Play, HelpCircle, Eye, Lock, Sparkles, X, User, Mail, Phone } from 'lucide-react';
                            ...
                            <div className="bg-gradient-to-br from-mystic-deep to-black border border-mystic-gold/30 rounded-2xl p-6 md:p-8 w-full max-w-3xl relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                                <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                                    ...
                                    <div className="flex-1 text-center md:text-left">
                                        ...
                                        <p className="text-gray-300 text-base md:text-lg mb-0">
                                            O Universo mostrou que <span className="text-mystic-gold font-bold">{readingCards[1].name}</span> está bloqueando seu caminho. Apenas a leitura completa revela como usar a energia de <span className="text-mystic-gold font-bold">{readingCards[2].name}</span> para resolver isso definitivamente.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 flex flex-col items-center">
                                    <button
                                        ...
                                        id="unlock-btn"
                                        className="btn-primary w-full md:w-auto text-lg px-12 py-4 shadow-[0_0_30px_rgba(255,215,0,0.3)] hover:shadow-[0_0_50px_rgba(255,215,0,0.5)] transform transition-transform hover:scale-105 flex items-center justify-center gap-3 group disabled:opacity-70 disabled:cursor-not-allowed"
                                    >
                                        <Lock size={20} className={isGenerating ? "hidden" : "group-hover:hidden"} />
                                        <Sparkles size={20} className={isGenerating ? "animate-spin" : "hidden group-hover:block animate-spin"} />
                                        {isGenerating ? "Processando..." : "Desbloquear Mensagem do Universo Agora"}
                                    </button >
                                    <p className="mt-4 text-xs text-mystic-muted flex items-center gap-2">
